(function (global, factory) {
  ...
  function bootstrap(opts, mountedInstances, singleSpaProps) {
    return Promise.resolve().then(function () {
      ...
      } catch (err) {// ignore - this means that the module doesn't exist
      }
  ...
  function mount(opts, mountedInstances) {
    ...
    return Promise.resolve().then(function () {
      ...
      if (opts.ngRoute) {
        var ngViewEl = document.createElement("div");
      ...
      mountedInstances.instance.get("$rootScope").singleSpaProps = props; // https://github.com/single-spa/single-spa-angularjs/issues/51
    ...
    return new Promise(function (resolve, reject) {
      if (mountedInstances.instance.has("$uiRouter")) {
        ...
        if (uiRouter.dispose) {
          ...
          console.warn("single-spa-angularjs: the uiRouter instance doesn't have a dispose method and so it will not be properly unmounted.");
        }
      }
